 ...
 "cells": [
  ...
  },
  {
   ...
   "source": [
    ...
    "data_path = '/home/lfelipe/sigpatsearch_devel/cython_wrapper/example_data/high_order_epistasis'\n",
    "dataset = 'avrB'\n",
    "\n",
    "genotype_file = os.path.join(data_path, dataset, 'X_Chr2_Offset0.dat')\n",
    "phenotype_file = os.path.join(data_path, dataset, 'Y.dat')\n",
    "covariate_file = os.path.join(data_path, dataset, 'C.dat')\n",
    "\n",
    "# Path to output directory\n",
    "output_path = os.path.join('/home/lfelipe/sigpatsearch_devel/cython_wrapper/example_output/high_order_epistasis', dataset)\n",
    "\n",
